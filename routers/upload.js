...
const {getAllReports, getSpecificReport, getReportsByConcern} = require("../methods/upload/searching_about/reports");
const {getSpecificResource, getAllResources, getResourcesByConcern} = require("../methods/upload/searching_about/resources");
const {getDataById, getDataByConcern} = require("../methods/upload/searching_about/data");
